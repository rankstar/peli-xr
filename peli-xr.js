...
//servidores de contenidos
	...
	var Newpct= function () {	
		...
		//retorna el Menu
			var array_menu=[
				new Item_menu('Peliculas en Castellano','views/img/folder.png',':vercontenido:newpct:tipobrdvd:'+ escape('http://www.newpct1.com/peliculas/')),
				new Item_menu('Estrenos de Cine','views/img/folder.png',':vercontenido:newpct:tipoestrenoscine:' + escape('http://www.newpct1.com/estrenos-de-cine/')),
		...
		switch (tipo)
			{
			case "tipobrdvd":
				page.metadata.title = "NewPct - Peliculas en Castellano";
				var url_2=escape('http://www.newpct1.com/include.inc/ajax.php/orderCategory.php?type=todo&leter=&sql=SELECT+DISTINCT+++%09%09%09%09%09%09t.torrentID%2C+++%09%09%09%09%09%09t.torrentCategoryID%2C+++%09%09%09%09%09%09t.torrentCategoryIDR%2C+++%09%09%09%09%09%09t.torrentImageID%2C+++%09%09%09%09%09%09t.torrentName%2C+++%09%09%09%09%09%09t.guid%2C+++%09%09%09%09%09%09t.torrentShortName%2C++%09%09%09%09%09%09t.torrentLanguage%2C++%09%09%09%09%09%09t.torrentSize%2C++%09%09%09%09%09%09t.calidad+as+calidad_%2C++%09%09%09%09%09%09t.torrentDescription%2C++%09%09%09%09%09%09t.torrentViews%2C++%09%09%09%09%09%09t.rating%2C++%09%09%09%09%09%09t.n_votos%2C++%09%09%09%09%09%09t.vistas_hoy%2C++%09%09%09%09%09%09t.vistas_ayer%2C++%09%09%09%09%09%09t.vistas_semana%2C++%09%09%09%09%09%09t.vistas_mes%2Ct.imagen%2Cc.imagen+as+imagenc++%09%09%09%09++FROM+torrentsFiles+as+t+++%09%09%09%09++LEFT+JOIN+torrentsCategories+c+ON+(t.torrentCategoryID+%3D+c.categoryID)+%09%09%09%09++WHERE++(t.torrentStatus+%3D+1+OR+t.torrentStatus+%3D+2)++AND+(t.torrentCategoryID+IN+(1537%2C+758%2C+1105%2C+760%2C+1225))++AND+t.home_active+%3D+0++++ORDER+BY+torrentDateAdded++DESC++LIMIT+0%2C+50&pag=1&tot=&ban=3&cate=1225');
			...
			case "tipoestrenoscine":
				...
				var url_2=escape('http://www.newpct1.com/include.inc/ajax.php/orderCategory.php?type=todo&leter=&sql=SELECT+DISTINCT+++%09%09%09%09%09%09t.torrentID%2C+++%09%09%09%09%09%09t.torrentCategoryID%2C+++%09%09%09%09%09%09t.torrentCategoryIDR%2C+++%09%09%09%09%09%09t.torrentImageID%2C+++%09%09%09%09%09%09t.torrentName%2C+++%09%09%09%09%09%09t.guid%2C+++%09%09%09%09%09%09t.torrentShortName%2C++%09%09%09%09%09%09t.torrentLanguage%2C++%09%09%09%09%09%09t.torrentSize%2C++%09%09%09%09%09%09t.calidad+as+calidad_%2C++%09%09%09%09%09%09t.torrentDescription%2C++%09%09%09%09%09%09t.torrentViews%2C++%09%09%09%09%09%09t.rating%2C++%09%09%09%09%09%09t.n_votos%2C++%09%09%09%09%09%09t.vistas_hoy%2C++%09%09%09%09%09%09t.vistas_ayer%2C++%09%09%09%09%09%09t.vistas_semana%2C++%09%09%09%09%09%09t.vistas_mes%2Ct.imagen%2Cc.imagen+as+imagenc++%09%09%09%09++FROM+torrentsFiles+as+t+++%09%09%09%09++LEFT+JOIN+torrentsCategories+c+ON+(t.torrentCategoryID+%3D+c.categoryID)+%09%09%09%09++WHERE++(t.torrentStatus+%3D+1+OR+t.torrentStatus+%3D+2)++AND+(t.torrentCategoryID+IN+(1231%2C+1165%2C+1230%2C+1232%2C+766%2C+765%2C+761%2C+848%2C+1224))++AND+t.home_active+%3D+0++++ORDER+BY+torrentDateAdded++DESC++LIMIT+0%2C+50&pag=1&tot=&ban=3&cate=1224');
				var params={'url_servidor': unescape(url_2),
					'page_uri': ':verenlaces:newpct:',
					'uri_siguiente': ':vercontenido:newpct:tipo1:',
					'subtitulo':false}	
			...
			case "tipovo":
				...
				var url_2=escape('http://www.newpct1.com/include.inc/ajax.php/orderCategory.php?type=todo&leter=&sql=SELECT+DISTINCT+++%09%09%09%09%09%09t.torrentID%2C+++%09%09%09%09%09%09t.torrentCategoryID%2C+++%09%09%09%09%09%09t.torrentCategoryIDR%2C+++%09%09%09%09%09%09t.torrentImageID%2C+++%09%09%09%09%09%09t.torrentName%2C+++%09%09%09%09%09%09t.guid%2C+++%09%09%09%09%09%09t.torrentShortName%2C++%09%09%09%09%09%09t.torrentLanguage%2C++%09%09%09%09%09%09t.torrentSize%2C++%09%09%09%09%09%09t.calidad+as+calidad_%2C++%09%09%09%09%09%09t.torrentDescription%2C++%09%09%09%09%09%09t.torrentViews%2C++%09%09%09%09%09%09t.rating%2C++%09%09%09%09%09%09t.n_votos%2C++%09%09%09%09%09%09t.vistas_hoy%2C++%09%09%09%09%09%09t.vistas_ayer%2C++%09%09%09%09%09%09t.vistas_semana%2C++%09%09%09%09%09%09t.vistas_mes%2Ct.imagen%2Cc.imagen+as+imagenc++%09%09%09%09++FROM+torrentsFiles+as+t+++%09%09%09%09++LEFT+JOIN+torrentsCategories+c+ON+(t.torrentCategoryID+%3D+c.categoryID)+%09%09%09%09++WHERE++(t.torrentStatus+%3D+1+OR+t.torrentStatus+%3D+2)++AND+(t.torrentCategoryID+IN+(779%2C+784%2C+787%2C+788%2C+786%2C+778))++AND+t.home_active+%3D+0++++ORDER+BY+torrentDateAdded++DESC++LIMIT+0%2C+50&pag=1&tot=&ban=3&cate=778');
				var params={'url_servidor': unescape(url_2),
					'page_uri': ':verenlaces:newpct:',
					'uri_siguiente': ':vercontenido:newpct:tipo1:',
					'subtitulo':false}	
	...
	var Newpctseries= function() {	
		...
		//retorna el Menu
			var array_menu=[
				new Item_menu('Ultimos Capitulos','views/img/folder.png',':vercontenido:newpctseries:ultimoscapitulos:'+ escape('http://www.newpct1.com/series/')),
